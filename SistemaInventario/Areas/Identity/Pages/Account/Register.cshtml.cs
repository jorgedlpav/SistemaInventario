        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //await _userManager.AddToRoleAsync(user, DS.Role_Admin); solo se uso para crear a usuario Admin
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirma tu email",
                        $"confirmar tu cuenta <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>has click en el enlace</a>.");
                    ...
                    else
                    {
                        ...
                        {
                            // Administrador esta registrando un nuevo usurio
